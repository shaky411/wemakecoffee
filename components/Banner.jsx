    ...
    return (
        <main className="flex flex-col overflow-hidden justify-center items-center bg-laurel-500 text-slate-100 gap-10 p-20">
            ...
            <div className="flex flex-col gap-5 justify-start items-start">
                ...
                <span className="font-thin">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officia, ullam.</span>
                <div className="flex gap-4 flex-col md:flex-row text-laurel-600 font-bold">
                    <Link 
                    href="/"
                    className="bg-laurel-200 py-3 px-5"
                    >
                        Contact us
                    </Link>
                    <Link 
                    href="/"
                    className="bg-green-300 py-3 px-5"
                    >
                        View our menu
                    </Link>
                </div>
